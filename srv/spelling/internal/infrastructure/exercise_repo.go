...
func (r *Repository) AddSpellingAttempt(ctx context.Context, params repo.AddSpellingAttemptParams) (*repo.SpellingExercise, error) {
...
func (r *Repository) ListExercisesByUserID(ctx context.Context, userID string) ([]SpellingExercise, error) {
	...
	for _, attempt := range attempts {
		spellingExercises = append(spellingExercises, SpellingExercise{
